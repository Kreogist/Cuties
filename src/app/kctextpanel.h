...
public:
    ...
    virtual QTextBlock getFirstBlock() const;
    virtual void setFirstBlock(const QTextBlock &value);
    virtual QTextBlock getLastBlock() const;
    virtual void setLastBlock(const QTextBlock &value);
