                             ...
                             const bool &forward)
{
        ...
        i= (forward==true)?i.next():i.previous())
    {
        ...
        currBlockData=(KCTextBlockData *)i.userData();
...
void KCTextSearcher::setPatternString(const QString &pattern)
{
    if(!pattern.isEmpty())
    {
        setPattern(pattern);
...
void KCTextSearcher::setIsCaseSensitive(bool value)
{
    isCaseSensitive = value;
}

void KCTextSearcher::recordResult(int startPos, int length)
{
    currBlockData->insertMatchedTextPositions(startPos,length);
}

void KCTextSearcher::requireStop()
{
    quitLock.lock();
    needQuit=true;
    quitLock.unlock();
...
//======KCTextSearchWorkerRegexp======
void KCTextSearcherRegexp::setPattern(const QString &pattern)
{
    regexp.setPattern(pattern);
}

void KCTextSearcherRegexp::setCaseSensitive(bool value)
{
...
void KCTextSearcherRegexp::match(const QString &text)
{
...
//======KCTextSearchWorkerStringMatcher
void KCTextSearcherStringMatcher::setPattern(const QString &pattern)
{
    matcher.setPattern(pattern);
}

void KCTextSearcherStringMatcher::setCaseSensitive(bool value)
{
...
void KCTextSearcherStringMatcher::match(const QString &text)
{
