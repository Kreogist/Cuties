    ...
    QDockWidget(parent)
{
    ...
    compileOutputInfoSplitter->setObjectName("CompilerContainter");
    ...
    KCColorConfigure::getInstance()->getPalette(pal,
                                                compileOutputInfoSplitter->objectName());
    ...
    compileOutputErrorInfoTree->setObjectName("CompileErrorTree");
