...
//Message Box Title
kciMessageBoxTitle::kciMessageBoxTitle(QWidget *parent) :
    QWidget(parent)
{
    //Set Properties.
    setFixedHeight(30);
...
kciMessageBoxPanel::kciMessageBoxPanel(QWidget *parent) :
    QWidget(parent)
{
    //Set Properties.
    //setFixedHeight();
    ...
    QDialog(parent)
{
    ...
    //Set Title Widget
    titleWidget=new kciMessageBoxTitle(this);
    mainLayout->addWidget(titleWidget);
}

void kciMessageBox::startAnime()
{
