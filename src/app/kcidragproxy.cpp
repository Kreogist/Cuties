...
kciDragProxy::~kciDragProxy()
{
}

void kciDragProxy::setBorderWidth(int top, int right, int bottom, int left)
{
    m_top = top;
    m_right = right;
    m_bottom = bottom;
...
void kciDragProxy::updateGeometry(int x, int y, int w, int h)
{
...
void kciDragProxy::startCursorTimer()
{
    stopCursorTimer();
